...
let
  ...
  callPackage = lib.callPackageWith nixpkgs;

  jdk8cpu-linux = import <nixpkgs/pkgs/development/compilers/oraclejdk/jdk-linux-base.nix> {
    productVersion = "8";
    patchVersion = "144";
  ...
  oraclejdk8 = callPackage jdk8cpu-linux { };
